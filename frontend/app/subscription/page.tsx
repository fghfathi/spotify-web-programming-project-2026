...
// Subscription checkout (Step 6). Lists the active plans, shows the current
// tier, and starts a real payment: POST /api/payments/create/ returns the
// gateway redirect URL, and the browser is sent there to pay.
            ...
            {plans.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    type="button"
                    disabled={payingId !== null || isCurrent}
